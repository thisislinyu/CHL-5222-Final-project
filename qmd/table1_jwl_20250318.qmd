...
## combine columns
mmr_data_tab <- cbind(num_school_mmr, enroll_mmr, type_mmr) %>%
  mutate(Group = "MMR")
...
# combine columns
overall_data_tab <- cbind(num_school_all, enroll_all, type_all) %>%
...
## combine columns
both_data_tab <- cbind(num_school_both, enroll_both, type_both) %>%
