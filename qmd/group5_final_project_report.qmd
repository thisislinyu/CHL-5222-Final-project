...
### Check model diagnostics of main model
...
### Intra-class clustering (Table 3)
...
# condmean <- predict(lmm3mmr)
# y <- vaccine_mmr$mmr_recode[!is.na(vaccine_mmr$county)]
# 
...
## Intra-class clustering of main model (Table 3)
